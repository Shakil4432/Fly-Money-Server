            ...
            >
              ...
              <SwiperSlide>
                <motion.div
                  initial="hidden"
                  animate="visible"
                  className="bg-gray-100 flex flex-col md:flex-row items-center justify-between p-6 md:p-16 lg:h-[60vh] rounded-2xl"
                >
                  <motion.div
              ...
              <SwiperSlide>
                <motion.div
                  initial="hidden"
                  animate="visible"
                  className="bg-[#f9f5f0]/40 flex flex-col md:flex-row items-center justify-between p-6 md:p-16 lg:h-[60vh] md:h-[50vh] rounded-2xl"
                >
                  <motion.div
                    variants={textVariant}
                    className="text-center md:text-left mb-6 md:mb-0"
