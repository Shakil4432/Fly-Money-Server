...
export default function UserDashboardProfile({
  ...
  return (
    <div className="max-w-5xl mx-auto lg:mt-20">
      {!editMode ? (
        <Card className="relative lg:h-[60vh] overflow-hidden lg:rounded-2xl shadow-sm lg:shadow-md border bg-gradient-to-br from-gray-50 to-white">
          {/* Cover Header */}
        ...
        <Card className="p-6 rounded-2xl lg:shadow-md border">
